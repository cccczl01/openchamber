# NoatinWork Docs Source

This package is the source-of-truth for NoatinWork public docs content.
...
Website rendering/deployment happens in `noatinwork-website` (`apps/docs`).
