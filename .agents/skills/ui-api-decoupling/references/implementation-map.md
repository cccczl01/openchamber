...
- `packages/web/server/lib/opencode/core-routes.js`: installs NoatinWork route families.
...
Explicit NoatinWork routes must register before the generic `/api/*` OpenCode proxy.
