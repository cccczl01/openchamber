...
const MOBILE_CONNECTIONS_STORAGE_KEY = 'noatinwork.mobile.connections.v1';
const MOBILE_SECURE_STORAGE_PREFIX = 'noatinwork.mobile.';
const MOBILE_DEVICE_ID_STORAGE_KEY = 'noatinwork.mobile.deviceId';
  ...
  const redeemPairingConnection = React.useCallback(async (payload: PairingConnectionPayload) => {
    ...
    try {
      ...
      const redeemBody = JSON.stringify({
        ...
        clientLabel: 'NoatinWork Mobile',
        clientKind: 'mobile',
        deviceName: 'NoatinWork Mobile',
  ...
  const submitPassword = React.useCallback(async (password: string) => {
    ...
    try {
      ...
      const loginInit = {
        ...
        body: JSON.stringify({ password, trustDevice: true, issueClientToken: true, clientLabel: 'NoatinWork Mobile', clientKind: 'mobile', devicePlatform: mobileDevicePlatform(), dedupeKey: mobileClientDedupeKey() }),
      };
