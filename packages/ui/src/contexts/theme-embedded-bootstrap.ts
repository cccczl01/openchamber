...
type ThemeBootstrapWindow = Window & {
  __noatinworkEmbeddedThemeBootstrap?: unknown;
};
...
export const publishEmbeddedThemeBootstrap = (theme: Theme): void => {
  ...
  (window as ThemeBootstrapWindow).__noatinworkEmbeddedThemeBootstrap = theme;
};
...
export const readEmbeddedThemeBootstrap = (): Theme | null => {
  ...
  try {
    ...
    return isValidTheme(parent.__noatinworkEmbeddedThemeBootstrap)
      ? parent.__noatinworkEmbeddedThemeBootstrap
      : null;
  } catch {
    return null;
  }
