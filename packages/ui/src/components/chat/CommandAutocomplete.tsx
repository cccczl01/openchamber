...
type CommandSource = 'noatinwork' | 'opencode' | 'skill';
      ...
      try {
        ...
        const builtInCommands: CommandInfo[] = [
          ...(hasSession && !hasMessagesInCurrentSession
            ? [{ id: 'noatinwork:init', name: 'init', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.initDescription'), isBuiltIn: true }]
            : []
          ),
          ...(hasSession  // Show when session exists, not when hasMessages
            ? [
                { id: 'noatinwork:undo', name: 'undo', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.undoDescription'), isBuiltIn: true },
                { id: 'noatinwork:redo', name: 'redo', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.redoDescription'), isBuiltIn: true },
                { id: 'noatinwork:timeline', name: 'timeline', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.timelineDescription'), isBuiltIn: true },
              ]
            : []
          ),
          { id: 'noatinwork:compact', name: 'compact', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.compactDescription'), isBuiltIn: true },
          ...(hasSession
            ? [{ id: 'noatinwork:summary', name: 'summary', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.summaryDescription'), isNoatinWork: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'noatinwork:workspace-review', name: 'workspace-review', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.workspaceReviewDescription'), isNoatinWork: true }]
            : []
          ),
          ...(canUseReviewHandoffFlow
            ? [{ id: 'noatinwork:handoff-review', name: 'handoff-review', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.handoffReviewDescription'), isNoatinWork: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'noatinwork:plan-feature', name: 'plan-feature', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.featurePlanDescription'), isNoatinWork: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'noatinwork:craft-goal', name: 'craft-goal', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.craftGoalDescription'), isNoatinWork: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'noatinwork:schedule-task', name: 'schedule-task', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.scheduleTaskDescription'), isNoatinWork: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'noatinwork:catch-up', name: 'catch-up', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.catchUpDescription'), isNoatinWork: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'noatinwork:debug', name: 'debug', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.debugDescription'), isNoatinWork: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'noatinwork:weigh', name: 'weigh', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.weighDescription'), isNoatinWork: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'noatinwork:explore', name: 'explore', source: 'noatinwork' as const, description: t('chat.commandAutocomplete.command.exploreDescription'), isNoatinWork: true }]
            : []
          ),
        ];
        ...
        {loading ? (
          ...
          <div>
            {commands.map((command, index) => {
              ...
              const isNoatinWorkBadge = command.isNoatinWork;
              return (
                <div
                  key={command.id}
