...
// mounts (see the `__noatinworkEnsureNerdFonts` hook in index.html). Wait for
...
const ensureNerdFonts = (): Promise<void> => {
  ...
  const loader = (window as typeof window & { __noatinworkEnsureNerdFonts?: () => Promise<void> }).__noatinworkEnsureNerdFonts;
