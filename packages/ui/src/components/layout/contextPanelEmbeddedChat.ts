...
export const EMBEDDED_RUNTIME_BOOTSTRAP_REQUEST = 'noatinwork:embedded-runtime-bootstrap-request';
export const EMBEDDED_RUNTIME_BOOTSTRAP_RESPONSE = 'noatinwork:embedded-runtime-bootstrap-response';
