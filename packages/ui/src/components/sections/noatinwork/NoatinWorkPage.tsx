...
import { NoatinWorkVisualSettings } from './NoatinWorkVisualSettings';
...
import type { NoatinWorkSection } from './types';
...
interface NoatinWorkPageProps {
    /** Which section to display. If undefined, shows all sections (mobile/legacy behavior) */
    section?: NoatinWorkSection;
}

export const NoatinWorkPage: React.FC<NoatinWorkPageProps> = ({ section }) => {
    const { t } = useI18n();
    ...
    if (!section) {
        return (
            <SettingsPageLayout showSaveStatus className="noatinwork-page-body space-y-3 sm:space-y-6">
                <NoatinWorkVisualSettings />
                <DefaultsSettings />
    ...
    return (
        <SettingsPageLayout
            ...
            showSaveStatus
            className="noatinwork-page-body"
        >
...
const GeneralSectionContent: React.FC = () => {
    ...
    return (
        <>
            ...
            {!isVSCode && <OpenCodeCliSettings />}
            <NoatinWorkVisualSettings visibleSettings={[
                'fileEditorKeymap',
                'autoSaveEnabled',
...
const VisualSectionContent: React.FC = () => {
    const isVSCode = isVSCodeRuntime();
    return <NoatinWorkVisualSettings visibleSettings={[
        'theme',
