...
const THEME_MODE_OPTIONS: Array<{ value: ThemeMode; labelKey: string; descriptionKey: string }> = [
    {
        value: 'system',
        labelKey: 'settings.noatinwork.visual.option.themeMode.system',
        descriptionKey: 'settings.noatinwork.visual.option.themeMode.system.description',
    },
    {
        value: 'light',
        labelKey: 'settings.noatinwork.visual.option.themeMode.light',
        descriptionKey: 'settings.noatinwork.visual.option.themeMode.light.description',
    },
    {
        value: 'dark',
        labelKey: 'settings.noatinwork.visual.option.themeMode.dark',
        descriptionKey: 'settings.noatinwork.visual.option.themeMode.dark.description',
    },
];
...
const DIFF_LAYOUT_OPTIONS: Option<'dynamic' | 'inline' | 'side-by-side'>[] = [
    {
        id: 'dynamic',
        labelKey: 'settings.noatinwork.visual.option.diffLayout.dynamic.label',
        descriptionKey: 'settings.noatinwork.visual.option.diffLayout.dynamic.description',
    },
    {
        id: 'inline',
        labelKey: 'settings.noatinwork.visual.option.diffLayout.inline.label',
        descriptionKey: 'settings.noatinwork.visual.option.diffLayout.inline.description',
    },
    {
        id: 'side-by-side',
        labelKey: 'settings.noatinwork.visual.option.diffLayout.sideBySide.label',
        descriptionKey: 'settings.noatinwork.visual.option.diffLayout.sideBySide.description',
    },
];
...
const MERMAID_RENDERING_OPTIONS: Option<'svg' | 'ascii'>[] = [
    {
        id: 'svg',
        labelKey: 'settings.noatinwork.visual.option.mermaidRendering.svg.label',
        descriptionKey: 'settings.noatinwork.visual.option.mermaidRendering.svg.description',
    },
    {
        id: 'ascii',
        labelKey: 'settings.noatinwork.visual.option.mermaidRendering.ascii.label',
        descriptionKey: 'settings.noatinwork.visual.option.mermaidRendering.ascii.description',
    },
];

const DEFAULT_PWA_INSTALL_NAME = 'NoatinWork - AI Coding Assistant';
const PWA_ORIENTATION_OPTIONS: Option<'system' | 'portrait' | 'landscape'>[] = [
    {
        id: 'system',
        labelKey: 'settings.noatinwork.visual.option.pwaOrientation.system.label',
        descriptionKey: 'settings.noatinwork.visual.option.pwaOrientation.system.description',
    },
    {
        id: 'portrait',
        labelKey: 'settings.noatinwork.visual.option.pwaOrientation.portrait.label',
        descriptionKey: 'settings.noatinwork.visual.option.pwaOrientation.portrait.description',
    },
    {
        id: 'landscape',
        labelKey: 'settings.noatinwork.visual.option.pwaOrientation.landscape.label',
        descriptionKey: 'settings.noatinwork.visual.option.pwaOrientation.landscape.description',
    },
];
...
const MOBILE_KEYBOARD_MODE_OPTIONS: Option<MobileKeyboardMode>[] = [
    {
        id: 'native',
        labelKey: 'settings.noatinwork.visual.option.mobileKeyboardMode.native.label',
        descriptionKey: 'settings.noatinwork.visual.option.mobileKeyboardMode.native.description',
    },
    {
        id: 'resize-content',
        labelKey: 'settings.noatinwork.visual.option.mobileKeyboardMode.resizeContent.label',
        descriptionKey: 'settings.noatinwork.visual.option.mobileKeyboardMode.resizeContent.description',
    },
];
...
const MOBILE_LAYOUT_OPTIONS: Array<{ value: MobileLayoutPreference; labelKey: string }> = [
    {
        value: 'default',
        labelKey: 'settings.noatinwork.visual.option.mobileLayout.default',
    },
    {
        value: 'new',
        labelKey: 'settings.noatinwork.visual.option.mobileLayout.new',
    },
];

type PwaInstallNameWindow = Window & {
    __NOATINWORK_SET_PWA_INSTALL_NAME__?: (value: string) => string;
    __NOATINWORK_SET_PWA_ORIENTATION__?: (value: 'system' | 'portrait' | 'landscape') => 'system' | 'portrait' | 'landscape';
    __NOATINWORK_UPDATE_PWA_MANIFEST__?: () => void;
};
...
const USER_MESSAGE_RENDERING_OPTIONS: Option<'markdown' | 'plain'>[] = [
    {
        id: 'markdown',
        labelKey: 'settings.noatinwork.visual.option.userMessageRendering.markdown.label',
        descriptionKey: 'settings.noatinwork.visual.option.userMessageRendering.markdown.description',
    },
    {
        id: 'plain',
        labelKey: 'settings.noatinwork.visual.option.userMessageRendering.plain.label',
        descriptionKey: 'settings.noatinwork.visual.option.userMessageRendering.plain.description',
    },
];
...
const CHAT_RENDER_MODE_OPTIONS: Option<'sorted' | 'live'>[] = [
    {
        id: 'sorted',
        labelKey: 'settings.noatinwork.visual.option.chatRenderMode.sorted.label',
        descriptionKey: 'settings.noatinwork.visual.option.chatRenderMode.sorted.description',
    },
    {
        id: 'live',
        labelKey: 'settings.noatinwork.visual.option.chatRenderMode.live.label',
        descriptionKey: 'settings.noatinwork.visual.option.chatRenderMode.live.description',
    },
];
...
const MESSAGE_STREAM_TRANSPORT_OPTIONS: Option<'auto' | 'ws' | 'sse'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.noatinwork.visual.option.messageTransport.auto.label',
        descriptionKey: 'settings.noatinwork.visual.option.messageTransport.auto.description',
    },
    {
        id: 'ws',
        labelKey: 'settings.noatinwork.visual.option.messageTransport.ws.label',
        descriptionKey: 'settings.noatinwork.visual.option.messageTransport.ws.description',
    },
    {
        id: 'sse',
        labelKey: 'settings.noatinwork.visual.option.messageTransport.sse.label',
        descriptionKey: 'settings.noatinwork.visual.option.messageTransport.sse.description',
    },
];
...
const ACTIVITY_RENDER_MODE_OPTIONS: Option<'collapsed' | 'summary'>[] = [
    {
        id: 'collapsed',
        labelKey: 'settings.noatinwork.visual.option.activityRenderMode.collapsed.label',
        descriptionKey: 'settings.noatinwork.visual.option.activityRenderMode.collapsed.description',
    },
    {
        id: 'summary',
        labelKey: 'settings.noatinwork.visual.option.activityRenderMode.summary.label',
        descriptionKey: 'settings.noatinwork.visual.option.activityRenderMode.summary.description',
    },
];
...
const TIME_FORMAT_OPTIONS: Option<'auto' | '12h' | '24h'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.noatinwork.visual.option.timeFormat.auto.label',
        descriptionKey: 'settings.noatinwork.visual.option.timeFormat.auto.description',
    },
    {
        id: '24h',
        labelKey: 'settings.noatinwork.visual.option.timeFormat.24h.label',
        descriptionKey: 'settings.noatinwork.visual.option.timeFormat.24h.description',
    },
    {
        id: '12h',
        labelKey: 'settings.noatinwork.visual.option.timeFormat.12h.label',
        descriptionKey: 'settings.noatinwork.visual.option.timeFormat.12h.description',
    },
];
...
const WEEK_START_OPTIONS: Option<'auto' | 'monday' | 'sunday'>[] = [
    {
        id: 'auto',
        labelKey: 'settings.noatinwork.visual.option.weekStart.auto.label',
        descriptionKey: 'settings.noatinwork.visual.option.weekStart.auto.description',
    },
    {
        id: 'monday',
        labelKey: 'settings.noatinwork.visual.option.weekStart.monday.label',
    },
    {
        id: 'sunday',
        labelKey: 'settings.noatinwork.visual.option.weekStart.sunday.label',
    },
];
...
const FOLLOW_UP_BEHAVIOR_OPTIONS: Option<FollowUpBehavior>[] = [
    {
        id: 'steer',
        labelKey: 'settings.noatinwork.visual.option.followUpBehavior.steer.label',
    },
    {
        id: 'queue',
        labelKey: 'settings.noatinwork.visual.option.followUpBehavior.queue.label',
    },
];
...
const WINDOW_CONTROLS_POSITION_OPTIONS: Array<{ id: DesktopWindowControlsPosition; labelKey: string }> = [
    { id: 'left', labelKey: 'settings.noatinwork.desktopNetwork.option.windowControlsLeft' },
    { id: 'right', labelKey: 'settings.noatinwork.desktopNetwork.option.windowControlsRight' },
];

const WINDOW_CONTROLS_STYLE_OPTIONS: Array<{ id: DesktopWindowControlsStyle; labelKey: string }> = [
    { id: 'classic', labelKey: 'settings.noatinwork.desktopNetwork.option.windowControlsClassic' },
    { id: 'traffic-lights', labelKey: 'settings.noatinwork.desktopNetwork.option.windowControlsTrafficLights' },
];

interface NoatinWorkVisualSettingsProps {
    /** Which settings to show. If undefined, shows all. */
    visibleSettings?: VisibleSetting[];
}

export const NoatinWorkVisualSettings: React.FC<NoatinWorkVisualSettingsProps> = ({ visibleSettings }) => {
    ...
    const dockBadgeSupported = React.useMemo(
        () => isDesktopShell() && typeof window !== 'undefined'
            && (window as unknown as { __NOATINWORK_PLATFORM__?: string }).__NOATINWORK_PLATFORM__ === 'darwin',
        [],
    );
    ...
    const handleFileViewerPreviewChange = React.useCallback((enabled: boolean) => {
        ...
        window.dispatchEvent(new CustomEvent('noatinwork:file-viewer-preview-mode-changed', { detail: { enabled } }));
    ...
    const selectedTimeFormatLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.noatinwork.visual.option.timeFormat.auto.label');
    ...
    const selectedWeekStartLabel = React.useMemo(() => {
        ...
        return tUnsafe(option?.labelKey ?? 'settings.noatinwork.visual.option.weekStart.auto.label');
    ...
    const applyPwaInstallName = React.useCallback(async (value: string) => {
        ...
        if (typeof win.__NOATINWORK_SET_PWA_INSTALL_NAME__ === 'function') {
            const resolved = win.__NOATINWORK_SET_PWA_INSTALL_NAME__(persistedValue);
            setPwaInstallName(resolved);
            return;
        }

        setPwaInstallName(persistedValue || DEFAULT_PWA_INSTALL_NAME);
        win.__NOATINWORK_UPDATE_PWA_MANIFEST__?.();
    }, []);
    ...
    const applyPwaOrientation = React.useCallback(async (value: 'system' | 'portrait' | 'landscape') => {
        ...
        if (typeof win.__NOATINWORK_SET_PWA_ORIENTATION__ === 'function') {
            const resolved = win.__NOATINWORK_SET_PWA_ORIENTATION__(normalized);
    ...
    return (
        <div className="space-y-0">
                ...
                {hasAppearanceSettings && (
                    <div className="space-y-0">
                        {hasThemeSettings && (
                            <SettingsSection title={t('settings.noatinwork.visual.section.colorModeAndTheme')} divider={false}>
                                <SettingsTwoColumn>
                                    <div className={SETTINGS_FIELDS_STACK_CLASS}>
                                        <SettingsRadioGroup aria-label={t('settings.noatinwork.visual.section.colorMode')}>
                                        ...
                                        {showMobileLayoutSetting && (
                                            <SettingsInset>
                                                <SettingsStackedField label={t('settings.noatinwork.visual.section.mobileLayout')}>
                                                    <SettingsChipGroup
                                                        ...
                                                        aria-label={t('settings.noatinwork.visual.section.mobileLayout')}
                                                    />
                                                </SettingsStackedField>
                                            </SettingsInset>
                                        )}
                                    ...
                                    <div className={SETTINGS_FIELDS_STACK_CLASS}>
                                        <SettingsStackedField
                                            label={t('settings.noatinwork.visual.field.lightTheme')}
                                            settingsItem="appearance.light-theme"
                                        >
                                            <Select value={selectedLightTheme?.metadata.id ?? ''} onValueChange={setLightThemePreference}>
                                                <SelectTrigger aria-label={t('settings.noatinwork.visual.field.selectLightThemeAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                                    <SelectValue placeholder={t('settings.noatinwork.visual.field.selectThemePlaceholder')}>
                                                        {selectedLightTheme
                                        ...
                                        <SettingsStackedField
                                            label={t('settings.noatinwork.visual.field.darkTheme')}
                                            settingsItem="appearance.dark-theme"
                                        >
                                            <Select value={selectedDarkTheme?.metadata.id ?? ''} onValueChange={setDarkThemePreference}>
                                                <SelectTrigger aria-label={t('settings.noatinwork.visual.field.selectDarkThemeAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                                    <SelectValue placeholder={t('settings.noatinwork.visual.field.selectThemePlaceholder')}>
                                                        {selectedDarkTheme
                                        ...
                                        <div className="flex items-center gap-2 pt-1">
                                            ...
                                            >
                                                ...
                                                {themesReloading ? t('settings.noatinwork.visual.actions.reloadingThemes') : t('settings.noatinwork.visual.actions.reloadThemes')}
                                            </button>
                                            <SettingsInfoHint>
                                                {t('settings.noatinwork.visual.field.themeImportInfoTooltip')}
                                            </SettingsInfoHint>
                                        </div>
                                    </div>
                                </SettingsTwoColumn>
                                ...
                                {dockBadgeSupported && (
                                    <SettingsInset settingsItem="appearance.dock-badge">
                                        <SettingsCheckboxRow
                                            ...
                                            label={t('settings.noatinwork.visual.field.dockBadge')}
                                            info={t('settings.noatinwork.visual.field.dockBadgeHint')}
                                            ariaLabel={t('settings.noatinwork.visual.field.dockBadge')}
                                        />
                                    </SettingsInset>
                                )}
                            </SettingsSection>
                        ...
                        {showWindowControlsPositionSetting && (
                            <SettingsSection
                                title={t('settings.noatinwork.desktopNetwork.field.windowControls')}
                                info={t('settings.noatinwork.desktopNetwork.field.windowControlsPositionDescription')}
                                divider={hasThemeSettings}
                            >
                                <SettingsTwoColumn>
                                    <SettingsStackedField
                                        label={t('settings.noatinwork.desktopNetwork.field.windowControlsPosition')}
                                    ...
                                    >
                                        <SettingsChipGroup
                                            ...
                                            aria-label={t('settings.noatinwork.desktopNetwork.field.windowControlsPositionAria')}
                                        />
                                    </SettingsStackedField>
                                    <SettingsStackedField
                                        label={t('settings.noatinwork.desktopNetwork.field.windowControlsStyle')}
                                    ...
                                    >
                                        <SettingsChipGroup
                                            ...
                                            aria-label={t('settings.noatinwork.desktopNetwork.field.windowControlsStyleAria')}
                                        />
                                    </SettingsStackedField>
                                </SettingsTwoColumn>
                            </SettingsSection>
                        ...
                        {hasLocalizationSettings && (
                            <SettingsSection title={t('settings.noatinwork.visual.section.localization')}>
                                <SettingsTwoColumn>
                                    <SettingsStackedField
                                    ...
                                    {(shouldShow('timeFormat') || shouldShow('weekStart')) && (
                                        <div className={SETTINGS_FIELDS_STACK_CLASS}>
                                            {shouldShow('timeFormat') && (
                                                <SettingsStackedField
                                                    label={t('settings.noatinwork.visual.field.timeFormat')}
                                                ...
                                                >
                                                    <Select value={timeFormatPreference} onValueChange={(value: 'auto' | '12h' | '24h') => handleTimeFormatPreferenceChange(value)}>
                                                        <SelectTrigger aria-label={t('settings.noatinwork.visual.field.selectTimeFormatAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                            ...
                                            {shouldShow('weekStart') && (
                                                <SettingsStackedField
                                                    label={t('settings.noatinwork.visual.field.weekStartsOn')}
                                                ...
                                                >
                                                    <Select value={weekStartPreference} onValueChange={(value: 'auto' | 'monday' | 'sunday') => handleWeekStartPreferenceChange(value)}>
                                                        <SelectTrigger aria-label={t('settings.noatinwork.visual.field.selectWeekStartAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                        ...
                        {(showPwaInstallNameSetting || showPwaOrientationSetting || showMobileKeyboardModeSetting) && (
                            <SettingsSection title={t('settings.noatinwork.visual.section.appInstall')} contentClassName={SETTINGS_FIELDS_STACK_CLASS}>

                            {showPwaInstallNameSetting && (
                                <SettingsFieldRow
                                    label={t('settings.noatinwork.visual.field.installAppName')}
                                    info={t('settings.noatinwork.visual.field.installAppNameHint')}
                                ...
                                >
                                    <Input
                                        ...
                                        maxLength={64}
                                        aria-label={t('settings.noatinwork.visual.field.pwaInstallAppNameAria')}
                                    />
                                    <Button size="sm"
                                        type="button"
                                        variant="ghost"
                                        ...
                                        aria-label={t('settings.noatinwork.visual.actions.resetInstallAppNameAria')}
                            ...
                            {showPwaOrientationSetting && (
                                <SettingsFieldRow
                                    label={t('settings.noatinwork.visual.field.installOrientation')}
                                    description={t('settings.noatinwork.visual.field.installOrientationHint')}
                                ...
                                >
                                    ...
                                    >
                                        <SelectTrigger aria-label={t('settings.noatinwork.visual.field.pwaInstallOrientationAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_CLUSTER_CONTROL_CLASS}>
                                            <SelectValue placeholder={t('settings.noatinwork.visual.field.selectOrientationPlaceholder')}>
                                    ...
                                    <Button size="sm"
                                        ...
                                        className={SETTINGS_ICON_BUTTON_CLASS}
                                        aria-label={t('settings.noatinwork.visual.actions.resetInstallOrientationAria')}
                                        title={t('settings.common.actions.reset')}
                                    >
                                        <Icon name="restart" className="h-3.5 w-3.5" />
                                    </Button>
                            ...
                            {showMobileKeyboardModeSetting && (
                                <SettingsFieldRow
                                    label={t('settings.noatinwork.visual.field.mobileKeyboardMode')}
                                    info={t('settings.noatinwork.visual.field.mobileKeyboardModeHint')}
                                ...
                                >
                                    ...
                                    >
                                        <SelectTrigger aria-label={t('settings.noatinwork.visual.field.mobileKeyboardModeAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_CLUSTER_CONTROL_CLASS}>
                                            <SelectValue placeholder={t('settings.noatinwork.visual.field.selectMobileKeyboardModePlaceholder')}>
                                    ...
                                    <Button size="sm"
                                        ...
                                        className={SETTINGS_ICON_BUTTON_CLASS}
                                        aria-label={t('settings.noatinwork.visual.actions.resetMobileKeyboardModeAria')}
                                        title={t('settings.common.actions.reset')}
                                    >
                                        <Icon name="restart" className="h-3.5 w-3.5" />
                                    </Button>
                ...
                {/* --- Density & type --- */}
                {hasLayoutSettings && (
                    <SettingsSection title={t('settings.noatinwork.visual.section.densityAndType')} contentClassName={SETTINGS_FIELDS_STACK_CLASS}>
                        {(shouldShow('fontSize') && !isMobile) || shouldShow('terminalFontSize') ? (
                            <SettingsTwoColumn>
                                {shouldShow('fontSize') && !isMobile && (
                                    <SettingsStackedField
                                        label={t('settings.noatinwork.visual.field.interfaceFont')}
                                        settingsItem="appearance.interface-font-size"
                                        controlClassName="w-full"
                                    >
                                        <Select value={uiFont} onValueChange={(value) => setUiFont(value as UiFontOption)}>
                                            <SelectTrigger aria-label={t('settings.noatinwork.visual.field.selectInterfaceFontAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className={SETTINGS_ICON_BUTTON_CLASS}
                                            aria-label={t('settings.noatinwork.visual.actions.resetInterfaceFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                                ...
                                {shouldShow('terminalFontSize') && (
                                    <SettingsStackedField
                                        label={t('settings.noatinwork.visual.field.codeFont')}
                                        controlClassName="w-full"
                                    >
                                        <Select value={monoFont} onValueChange={(value) => setMonoFont(value as MonoFontOption)}>
                                            <SelectTrigger aria-label={t('settings.noatinwork.visual.field.selectCodeFontAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                        ...
                                        <Button size="sm"
                                            ...
                                            className={SETTINGS_ICON_BUTTON_CLASS}
                                            aria-label={t('settings.noatinwork.visual.actions.resetCodeFontAria')}
                                            title={t('settings.common.actions.reset')}
                                        >
                                            <Icon name="restart" className="h-3.5 w-3.5" />
                                        </Button>
                        ...
                        {(shouldShow('fontSize') && !isMobile) || shouldShow('terminalFontSize') || shouldShow('editorFontSize') ? (
                            <SettingsTwoColumn>
                                {shouldShow('fontSize') && !isMobile && (
                                    <SettingsStackedField
                                        label={t('settings.noatinwork.visual.field.interfaceFontSize')}
                                        controlClassName="w-full"
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            <NumberInput
                                                ...
                                                max={200}
                                                step={5}
                                                aria-label={t('settings.noatinwork.visual.field.fontSizePercentageAria')}
                                            />
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.noatinwork.visual.actions.resetFontSizeAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                                ...
                                {shouldShow('terminalFontSize') && (
                                    <SettingsStackedField
                                        label={t('settings.noatinwork.visual.field.terminalFontSize')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.noatinwork.visual.actions.resetTerminalFontSizeAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                                ...
                                {shouldShow('editorFontSize') && (
                                    <SettingsStackedField
                                        label={t('settings.noatinwork.visual.field.editorFontSize')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.noatinwork.visual.actions.resetEditorFontSizeAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                        ...
                        {shouldShow('spacing') || (shouldShow('inputBarOffset') && isMobile) ? (
                            <SettingsTwoColumn>
                                {shouldShow('spacing') && (
                                    <SettingsStackedField
                                        label={t('settings.noatinwork.visual.field.spacingDensity')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.noatinwork.visual.actions.resetSpacingAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                                ...
                                {shouldShow('inputBarOffset') && isMobile && (
                                    <SettingsStackedField
                                        label={t('settings.noatinwork.visual.field.inputBarOffset')}
                                        info={t('settings.noatinwork.visual.field.inputBarOffsetTooltip')}
                                    ...
                                    >
                                        <div className={SETTINGS_NUMBER_STEPPER_ROW_CLASS}>
                                            ...
                                            <Button size="sm"
                                                ...
                                                className={SETTINGS_ICON_BUTTON_CLASS}
                                                aria-label={t('settings.noatinwork.visual.actions.resetInputBarOffsetAria')}
                                                title={t('settings.common.actions.reset')}
                                            >
                                                <Icon name="restart" className="h-3.5 w-3.5" />
                                            </Button>
                ...
                {hasNavigationSettings && (
                    <SettingsSection title={t('settings.noatinwork.visual.section.navigation')} contentClassName="space-y-4">
                        {shouldShow('fileEditorKeymap') && (
                            <SettingsControlGroup
                                title={t('settings.noatinwork.visual.field.fileEditorKeymap')}
                                settingsItem="appearance.file-editor-keymap"
                            >
                                <SettingsRadioGroup aria-label={t('settings.noatinwork.visual.field.fileEditorKeymap')}>
                                    {(['default', 'vim'] as const).map((keymap) => (
                                        <SettingsRadioOption
                                            key={keymap}
                                            selected={fileEditorKeymap === keymap}
                                            onSelect={() => setFileEditorKeymap(keymap)}
                                            label={t(`settings.noatinwork.visual.option.fileEditorKeymap.${keymap}`)}
                                            ariaLabel={t(`settings.noatinwork.visual.option.fileEditorKeymap.${keymap}`)}
                                        />
                                    ))}
                                </SettingsRadioGroup>
                            </SettingsControlGroup>
                        ...
                        <div className={SETTINGS_OPTION_STACK_CLASS}>
                            {shouldShow('autoSaveEnabled') && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.noatinwork.visual.field.autoSaveEnabled')}
                                    ariaLabel={t('settings.noatinwork.visual.field.autoSaveEnabledAria')}
                                    info={t('settings.noatinwork.visual.field.autoSaveEnabledInfo')}
                            ...
                            {shouldShow('expandedEditorToolbar') && !isVSCode && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.noatinwork.visual.field.expandedEditorToolbar')}
                                    ariaLabel={t('settings.noatinwork.visual.field.expandedEditorToolbarAria')}
                            ...
                            {shouldShow('terminalQuickKeys') && !isMobile && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.noatinwork.visual.field.terminalQuickKeys')}
                                    ariaLabel={t('settings.noatinwork.visual.field.terminalQuickKeysAria')}
                                    settingsItem="appearance.terminal-quick-keys"
                                    info={t('settings.noatinwork.visual.field.terminalQuickKeysTooltip')}
                                />
                            )}
                            {showTerminalShellSetting && (
                                <SettingsStackedField
                                    label={t('settings.noatinwork.visual.field.terminalShell')}
                                    info={t('settings.noatinwork.visual.field.terminalShellHint')}
                                ...
                                >
                                    <Select value={terminalShell} onValueChange={(value) => { if (isTerminalShell(value)) setTerminalShell(value); }}>
                                        <SelectTrigger aria-label={t('settings.noatinwork.visual.field.terminalShellAria')} size={SETTINGS_SELECT_SIZE} className={SETTINGS_SELECT_TRIGGER_CLASS}>
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                                            <SelectItem value="auto">{t('settings.noatinwork.visual.option.terminalShell.auto')}</SelectItem>
                            ...
                            {showTerminalShellSetting && terminalShellSupportsLogin && (
                                <SettingsCheckboxRow
                                    ...
                                    label={t('settings.noatinwork.visual.field.terminalLoginShell')}
                                    ariaLabel={t('settings.noatinwork.visual.field.terminalLoginShell')}
                ...
                {hasBehaviorSettings && (
                    <>
                        {showBehaviorDisplaySettings && (
                            <SettingsSection
                                title={t('settings.noatinwork.visual.section.chatDisplay')}
                                divider={behaviorSectionDivider}
                                contentClassName="space-y-6"
                            >
                                {shouldShow('chatRenderMode') && (
                                    <SettingsControlGroup
                                        title={t('settings.noatinwork.visual.section.chatRenderMode')}
                                        settingsItem="chat.render-mode"
                                    >
                                        <div role="radiogroup" aria-label={t('settings.noatinwork.visual.section.chatRenderModeAria')} className="grid w-full max-w-[26rem] grid-cols-1 gap-3 @xl:grid-cols-2">
                                ...
                                {shouldShow('activityRenderMode') && chatRenderMode === 'sorted' && (
                                    <SettingsControlGroup title={t('settings.noatinwork.visual.section.activityDefault')}>
                                        <SettingsRadioGroup aria-label={t('settings.noatinwork.visual.section.activityDefaultAria')}>
                                            {ACTIVITY_RENDER_MODE_OPTIONS.map((option) => (
                                                <SettingsRadioOption
                                                    ...
                                                    label={tUnsafe(option.labelKey)}
                                                    ariaLabel={t('settings.noatinwork.visual.field.activityDefaultModeAria', { option: tUnsafe(option.labelKey) })}
                                                />
                                            ))}
                                        </SettingsRadioGroup>
                                    </SettingsControlGroup>
                        ...
                        {showTransportSection && (
                            <SettingsSection
                                title={t('settings.noatinwork.visual.section.messageStreamTransport')}
                            ...
                            >
                                <SettingsChipGroup
                                    ...
                                    aria-label={t('settings.noatinwork.visual.section.messageStreamTransport')}
                                />
                                {(() => {
                        ...
                        {showBehaviorMessageOptions && (
                            <SettingsSection
                                title={t('settings.noatinwork.visual.section.chatMessageOptions')}
                            ...
                            >
                                ...
                                <SettingsTwoColumn className="lg:gap-y-6">
                                    {shouldShow('userMessageRendering') && (
                                        <SettingsControlGroup title={t('settings.noatinwork.visual.section.userMessageRendering')}>
                                            <SettingsRadioGroup aria-label={t('settings.noatinwork.visual.section.userMessageRenderingAria')}>
                                                {USER_MESSAGE_RENDERING_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.noatinwork.visual.field.userMessageRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                                    ...
                                    {shouldShow('mermaidRendering') && (
                                        <SettingsControlGroup title={t('settings.noatinwork.visual.section.mermaidRendering')}>
                                            <SettingsRadioGroup aria-label={t('settings.noatinwork.visual.section.mermaidRenderingAria')}>
                                                {MERMAID_RENDERING_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.noatinwork.visual.field.mermaidRenderingAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                                    ...
                                    {shouldShow('diffLayout') && !isVSCode && (
                                        <SettingsControlGroup title={t('settings.noatinwork.visual.section.diffLayout')}>
                                            <SettingsRadioGroup aria-label={t('settings.noatinwork.visual.section.diffLayoutAria')}>
                                                {DIFF_LAYOUT_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.noatinwork.visual.field.diffLayoutAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                                    ...
                                    {shouldShow('followUpBehavior') && (
                                        <SettingsControlGroup
                                            title={t('settings.noatinwork.visual.section.followUpBehavior')}
                                            settingsItem="chat.follow-up-behavior"
                                        >
                                            <SettingsRadioGroup aria-label={t('settings.noatinwork.visual.section.followUpBehaviorAria')}>
                                                {FOLLOW_UP_BEHAVIOR_OPTIONS.map((option) => (
                                                    <SettingsRadioOption
                                                        ...
                                                        label={tUnsafe(option.labelKey)}
                                                        ariaLabel={t('settings.noatinwork.visual.field.followUpBehaviorAria', { option: tUnsafe(option.labelKey) })}
                                                    />
                                                ))}
                                            </SettingsRadioGroup>
                                        </SettingsControlGroup>
                        ...
                        {showBehaviorFeatureCheckboxes && (
                            <>
                                {shouldShow('expandedTools') && (
                                    <SettingsSection
                                        title={t('settings.noatinwork.visual.section.showToolsOpenedByDefault')}
                                    ...
                                    >
                                        <SettingsCheckboxRow
                                            ...
                                            label={t('settings.noatinwork.visual.field.bash')}
                                            ariaLabel={t('settings.noatinwork.visual.field.showExpandedBashToolsAria')}
                                        />
                                        <SettingsCheckboxRow
                                            checked={showExpandedEditTools}
                                            onChange={handleShowExpandedEditToolsChange}
                                            label={t('settings.noatinwork.visual.field.editTools')}
                                            ariaLabel={t('settings.noatinwork.visual.field.showExpandedEditToolsAria')}
                                        />
                                    </SettingsSection>
                                )}
                                <SettingsSection
                                    title={t('settings.noatinwork.visual.section.sessionAssistance')}
                                ...
                                >
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.noatinwork.visual.field.draftStartersVisible')}
                                        ariaLabel={t('settings.noatinwork.visual.field.draftStartersVisibleAria')}
                                    ...
                                    />
                                        {shouldShow('sessionAssist') && (
                                            <>
                                                <SettingsCheckboxRow
                                                    ...
                                                    label={t('settings.noatinwork.visual.field.sessionRecap')}
                                                    ariaLabel={t('settings.noatinwork.visual.field.sessionRecapAria')}
                                                    settingsItem="chat.session-recap"
                                                />
                                                <SettingsCheckboxRow
                                                    checked={sessionSuggestionEnabled}
                                                    onChange={setSessionSuggestionEnabled}
                                                    label={t('settings.noatinwork.visual.field.sessionSuggestion')}
                                                    ariaLabel={t('settings.noatinwork.visual.field.sessionSuggestionAria')}
                                        ...
                                        {shouldShow('subagentReadOnlyBanner') && (
                                            <SettingsCheckboxRow
                                                ...
                                                label={t('settings.noatinwork.visual.field.allowPromptingSubagentSessions')}
                                                ariaLabel={t('settings.noatinwork.visual.field.allowPromptingSubagentSessionsAria')}
                                ...
                                {shouldShow('sessionGoal') && !isVSCode && (
                                    <SettingsSection
                                        title={t('settings.noatinwork.visual.goal.sectionTitle')}
                                        info={t('settings.noatinwork.visual.goal.description')}
                                        contentClassName={SETTINGS_OPTION_STACK_CLASS}
                                    >
                                        <SettingsCheckboxRow
                                            checked={sessionGoalEnabled}
                                            onChange={setSessionGoalEnabled}
                                            label={t('settings.noatinwork.visual.field.sessionGoal')}
                                            ariaLabel={t('settings.noatinwork.visual.field.sessionGoalAria')}
                                        ...
                                        <div data-settings-item="chat.session-goal-budget" className="flex items-center gap-2">
                                            <SettingsCheckboxRow
                                                ...
                                                label={t('settings.noatinwork.visual.goal.budgetLabel')}
                                                ariaLabel={t('settings.noatinwork.visual.goal.budgetAria')}
                                            />
                                ...
                                {shouldShow('reasoning') && (
                                    <SettingsSection
                                        title={t('settings.noatinwork.visual.section.reasoning')}
                                    ...
                                    >
                                        <SettingsCheckboxRow
                                            ...
                                            label={t('settings.noatinwork.visual.field.showReasoningTraces')}
                                            ariaLabel={t('settings.noatinwork.visual.field.showReasoningTracesAria')}
                                        ...
                                        {showReasoningTraces && (
                                            <SettingsCheckboxRow
                                                ...
                                                label={t('settings.noatinwork.visual.field.collapsibleThinkingBlocks')}
                                                ariaLabel={t('settings.noatinwork.visual.field.collapsibleThinkingBlocksAria')}
                                            />
                                        )}
                                    </SettingsSection>
                                )}
                                ...
                                <SettingsSection
                                    title={t('settings.noatinwork.visual.section.messageAppearance')}
                                ...
                                {shouldShow('collapsibleUserMessages') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.noatinwork.visual.field.collapsibleUserMessages')}
                                        ariaLabel={t('settings.noatinwork.visual.field.collapsibleUserMessagesAria')}
                                ...
                                {shouldShow('stickyUserHeader') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.noatinwork.visual.field.stickyUserHeader')}
                                        ariaLabel={t('settings.noatinwork.visual.field.stickyUserHeaderAria')}
                                ...
                                {shouldShow('promptNavigatorEnabled') && !isVSCode && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.noatinwork.visual.field.promptNavigatorEnabled')}
                                        ariaLabel={t('settings.noatinwork.visual.field.promptNavigatorEnabledAria')}
                                ...
                                {shouldShow('wideChatLayout') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.noatinwork.visual.field.wideChatLayout')}
                                        ariaLabel={t('settings.noatinwork.visual.field.wideChatLayoutAria')}
                                ...
                                {shouldShow('splitAssistantMessageActions') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.noatinwork.visual.field.showSplitAssistantMessageActions')}
                                        ariaLabel={t('settings.noatinwork.visual.field.showSplitAssistantMessageActionsAria')}
                                        settingsItem="chat.inline-assistant-actions"
                                        info={t('settings.noatinwork.visual.field.showSplitAssistantMessageActionsTooltip')}
                                    />
                                )}
                                ...
                                {shouldShow('codeBlockLineWrap') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.noatinwork.visual.field.codeBlockLineWrap')}
                                        ariaLabel={t('settings.noatinwork.visual.field.codeBlockLineWrapAria')}
                                ...
                                <SettingsSection
                                    title={t('settings.noatinwork.visual.section.toolsAndFiles')}
                                ...
                                {shouldShow('showToolFileIcons') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.noatinwork.visual.field.showToolFileIcons')}
                                        ariaLabel={t('settings.noatinwork.visual.field.showToolFileIconsAria')}
                                ...
                                {shouldShow('showTurnChangedFiles') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.noatinwork.visual.field.showTurnChangedFiles')}
                                        ariaLabel={t('settings.noatinwork.visual.field.showTurnChangedFilesAria')}
                                ...
                                {shouldShow('dotfiles') && !isVSCodeRuntime() && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.noatinwork.visual.field.showDotfiles')}
                                        ariaLabel={t('settings.noatinwork.visual.field.showDotfilesAria')}
                                ...
                                {shouldShow('fileViewerPreview') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.noatinwork.defaults.field.openFilesPreview')}
                                        ariaLabel={t('settings.noatinwork.defaults.field.openFilesPreviewAria')}
                                    />
                                )}
                                </SettingsSection>
                                )}
                                ...
                                <SettingsSection
                                    title={t('settings.noatinwork.visual.section.composer')}
                                ...
                                {shouldShow('persistDraft') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.noatinwork.visual.field.persistDraftMessages')}
                                        ariaLabel={t('settings.noatinwork.visual.field.persistDraftMessagesAria')}
                                ...
                                {!isMobile && shouldShow('inputSpellcheck') && (
                                    <SettingsCheckboxRow
                                        ...
                                        label={t('settings.noatinwork.visual.field.enableSpellcheckInTextInputs')}
                                        ariaLabel={t('settings.noatinwork.visual.field.enableSpellcheckInTextInputsAria')}
                ...
                {shouldShow('reportUsage') && (
                    <SettingsSection title={t('settings.noatinwork.visual.section.privacy')}>
                        <SettingsCheckboxRow
                            checked={reportUsage}
                            onChange={handleReportUsageChange}
                            label={t('settings.noatinwork.visual.field.sendAnonymousUsageReports')}
                            info={t('settings.noatinwork.visual.field.sendAnonymousUsageReportsHint')}
                            ariaLabel={t('settings.noatinwork.visual.field.sendAnonymousUsageReportsAria')}
