...
const MENU_ACTION_EVENT = 'noatinwork:menu-action';
const CHECK_FOR_UPDATES_EVENT = 'noatinwork:check-for-updates';
...
export const useMenuActions = (
  ...
  const handleAction = React.useCallback(
    (action: MenuAction) => {
      switch (action) {
        ...
        case 'copy': {
          const copyEvent = new Event('noatinwork:copy', { cancelable: true });
  ...
  React.useEffect(() => {
    ...
    listen('noatinwork:menu-action', (evt) => {
    ...
    listen('noatinwork:check-for-updates', () => {
