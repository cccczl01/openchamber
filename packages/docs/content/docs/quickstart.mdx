---
title: Quickstart
description: Start NoatinWork quickly and pick the right app for the task.
---
...
2. Install the NoatinWork CLI (see [Install](/install/) for the one-line command).
3. Run `noatinwork --ui-password be-creative-here`.
...
You should see the NoatinWork session list in your browser. If it loads, you're up and running.
