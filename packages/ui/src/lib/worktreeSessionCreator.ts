...
import { getWorktreeSetupCommands, getWorktreeSetupWaitEnabled } from '@/lib/noatinworkConfig';
import {
...
const initializeSessionForWorktree = (sessionId: string, metadata: {
  ...
  sessionStore.initializeNewNoatinWorkSession(sessionId, configState.agents);
