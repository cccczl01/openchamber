...
Start NoatinWork locally, then run:
...
measure, then return to the terminal and press Enter. Use NoatinWork normally
...
bun run profile:browser -- --output /tmp/noatinwork-profile
