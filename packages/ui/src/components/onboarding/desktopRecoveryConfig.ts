  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running NoatinWork. Verify the address points to an NoatinWork server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The NoatinWork server at "${host || 'unknown'}" is not compatible with this app version. Update NoatinWork on the server, then try again.`,
