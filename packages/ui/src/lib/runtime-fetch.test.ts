  ...
  test('rewrites current-origin absolute API URLs only', () => {
    ...
    try {
      ...
      Object.defineProperty(globalThis, 'window', {
        configurable: true,
        value: { location: { origin: 'noatinwork-ui://app', href: 'noatinwork-ui://app/index.html' } },
      });

      expect(buildRuntimeFetchUrl('noatinwork-ui://app/api/config/settings')).toBe('https://api.example/api/config/settings');
