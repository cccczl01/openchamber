...
describe('getPullRequestDiff', () => {
  ...
  beforeEach(() => {
    ...
    resolveGitHubRepoFromDirectory.mockResolvedValue({
      repo: { owner: 'noatinwork', repo: 'noatinwork' },
      remoteUrl: 'git@github.com:ccccczl01/noatinwork.git',
    });
  });
  ...
  it('requests the diff for the resolved repository', async () => {
    ...
    expect(result.meta).toEqual({ owner: 'noatinwork', repo: 'noatinwork', number: 2122 });
