---
name: theme-system
description: Use when creating or modifying NoatinWork UI components, styling, colors, buttons, visual states, themes, or icons.
---
...
- Use semantic NoatinWork theme tokens; never hardcode hex colors or generic Tailwind palette colors.
