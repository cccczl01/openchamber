...
const ChatInputComponent: React.FC<ChatInputProps> = ({ onOpenSettings, scrollToBottom }) => {
    ...
    const handleDragEnter = (e: React.DragEvent) => {
        ...
        const isInternal = e.dataTransfer.types?.includes('application/x-noatinwork-file-path') ?? false;
    ...
    const handleDrop = async (e: React.DragEvent) => {
        ...
        const internalPath = e.dataTransfer.getData('application/x-noatinwork-file-path');
    ...
    const toggleDictation = React.useCallback(() => {
        window.dispatchEvent(new CustomEvent('noatinwork:dictation-toggle'));
    }, []);
