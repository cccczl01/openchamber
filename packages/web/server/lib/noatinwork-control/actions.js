export const NOATINWORK_CONTROL_ACTION_DEFINITIONS = Object.freeze([
...
export const NOATINWORK_CONTROL_ACTIONS = Object.freeze(
  NOATINWORK_CONTROL_ACTION_DEFINITIONS.map(({ action }) => action),
);

export const NOATINWORK_AGENT_TOOL_ACTION_DEFINITIONS = Object.freeze(
  NOATINWORK_CONTROL_ACTION_DEFINITIONS.filter(({ agentExposed }) => agentExposed !== false),
);

export const NOATINWORK_AGENT_TOOL_ACTIONS = Object.freeze(
  NOATINWORK_AGENT_TOOL_ACTION_DEFINITIONS.map(({ action }) => action),
);
