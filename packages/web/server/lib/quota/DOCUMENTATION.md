...
| `cursor` | Cursor | `providers/cursor.js` | Environment/token files, NoatinWork-managed credentials, or explicit one-time Cursor import |
...
| `ollama-cloud` | Ollama Cloud | `providers/ollama-cloud.js` | Manual cookie stored under `~/.config/noatinwork/quota/` |
| `wafer` | Wafer.ai | `providers/wafer.js` | `wafer`, `wafer-ai`, `wafer_ai`, `wafer.ai` |
| `opencode-go` | OpenCode Go | `providers/opencode-go.js` | Manual workspace ID and auth cookie stored under `~/.config/noatinwork/quota/` |
