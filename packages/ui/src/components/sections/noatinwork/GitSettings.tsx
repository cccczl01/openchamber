...
export const GitSettings: React.FC = () => {
  ...
  const viewOptions = React.useMemo(
    () => [
      { id: 'flat' as const, label: t('settings.noatinwork.git.option.flatList') },
      { id: 'tree' as const, label: t('settings.noatinwork.git.option.treeView') },
    ],
    [t]
  );
  ...
  return (
    <SettingsSection title={t('settings.noatinwork.git.title')}>
      <div className={SETTINGS_OPTION_STACK_CLASS}>
        <SettingsControlGroup
          settingsItem="git.changes-view"
          title={t('settings.noatinwork.git.changesViewTitle')}
        >
          <SettingsRadioGroup aria-label={t('settings.noatinwork.git.changesViewAria')}>
            {viewOptions.map((option) => (
              <SettingsRadioOption
                ...
                label={option.label}
                ariaLabel={t('settings.noatinwork.git.optionAria', { option: option.label })}
              />
            ))}
          </SettingsRadioGroup>
        </SettingsControlGroup>
        ...
        <SettingsCheckboxRow
          ...
          label={t('settings.noatinwork.git.enableGitmoji')}
          ariaLabel={t('settings.noatinwork.git.enableGitmojiAria')}
        />
        ...
        <SettingsCheckboxRow
          ...
          label={t('settings.noatinwork.git.showGitignored')}
          ariaLabel={t('settings.noatinwork.git.showGitignoredAria')}
        />
      </div>
    </SettingsSection>
  );
