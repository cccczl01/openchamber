...
import { registerNoatinWorkSessionRoutes } from '../noatinwork-sessions/routes.js';
import { registerNoatinWorkControlRoutes } from '../noatinwork-control/routes.js';
...
export const createFeatureRoutesRuntime = (dependencies) => {
  ...
  const registerRoutes = async (app, routeDependencies) => {
    ...
    registerNoatinWorkControlRoutes(app, { controlService: noatinWorkControlService });
