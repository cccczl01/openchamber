...
export const OpenCodeCliSettings: React.FC = () => {
  ...
  return (
    <SettingsSection title={t('settings.noatinwork.opencodeCli.title')}>
      <div className="space-y-0.5">
        <SettingsFieldRow
          settingsItem="sessions.opencode-binary"
          label={t('settings.noatinwork.opencodeCli.field.binaryPath')}
          info={(
            <>
              {t('settings.noatinwork.opencodeCli.tipPrefix')}
              {' '}
              <span className="font-mono">OPENCODE_BINARY</span>
              {' '}
              {t('settings.noatinwork.opencodeCli.tipMiddle')}
              {' '}
              <span className="font-mono">~/.config/noatinwork/settings.json</span>
              {'.'}
            </>
          )}
          alignEnd={false}
        ...
        >
          <Input
            ...
            placeholder={t('settings.noatinwork.opencodeCli.field.binaryPathPlaceholder')}
          ...
          <Button
            ...
            aria-label={t('settings.noatinwork.opencodeCli.actions.browseAria')}
            title={t('settings.noatinwork.opencodeCli.actions.browse')}
          >
        ...
        <SettingsInset className={SETTINGS_OPTION_STACK_CLASS}>
          {!isWindowsArm64() && (
            <SettingsCheckboxRow
              ...
              label={t('settings.noatinwork.opencodeCli.field.showUpdateNotifications')}
              ariaLabel={t('settings.noatinwork.opencodeCli.field.showUpdateNotificationsAria')}
            />
          )}
          ...
          <SettingsCheckboxRow
            ...
            label={t('settings.noatinwork.opencodeCli.field.agentControlTool')}
            ariaLabel={t('settings.noatinwork.opencodeCli.field.agentControlToolAria')}
            info={t('settings.noatinwork.opencodeCli.field.agentControlToolInfo')}
          />
