 ...
 * it as `window.__NOATINWORK_DESKTOP_BOOT_OUTCOME__`. This module provides
...
export function getInjectedBootOutcome(): DesktopBootOutcome | null {
  ...
  const raw = (window as { __NOATINWORK_DESKTOP_BOOT_OUTCOME__?: unknown })
    .__NOATINWORK_DESKTOP_BOOT_OUTCOME__;
