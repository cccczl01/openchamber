...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install NoatinWork for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'NoatinWork installed',
  ...
  'mobile.connect.welcome.title': 'Connect to NoatinWork',
  ...
  'mobile.connect.password.placeholder': 'NoatinWork password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an NoatinWork connection code.',
  ...
  'mobile.connect.relay.badge': 'via NoatinWork Relay',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that NoatinWork server.',
  ...
  'sessions.sidebar.footer.actions.aboutNoatinWork': 'About NoatinWork',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The NoatinWork server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to NoatinWork — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in NoatinWork. Download it to open with another app.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'NoatinWork needs access to this folder.',
  ...
  'aboutDialog.noatinWorkVersionLabel': 'NoatinWork version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes NoatinWork state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate NoatinWork efficiently',
  ...
  'header.actions.openAppMenu': 'NoatinWork menu',
  'header.actions.openAppMenuAria': 'Open NoatinWork menu',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening NoatinWork from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock NoatinWork',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote NoatinWork servers',
  ...
  'multiRun.window.description': 'NoatinWork Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to NoatinWork',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If NoatinWork does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of NoatinWork — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to NoatinWork settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an NoatinWork server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an NoatinWork server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different NoatinWork version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running NoatinWork but is not compatible with this app version. Update NoatinWork on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running NoatinWork. Verify the address points to an NoatinWork server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running NoatinWork. Verify the address points to an NoatinWork server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The NoatinWork server at "{host}" is not compatible with this app version. Update NoatinWork on the server, then try again.',
  ...
  'startup.initRecovery.description': 'NoatinWork could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating NoatinWork...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: noatinwork update',
  'mobileUpdate.toast.available.title': 'NoatinWork update available',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep NoatinWork open.',
  ...
  'noatinWorkLogo.aria.logo': 'NoatinWork logo',
