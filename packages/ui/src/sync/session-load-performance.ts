const STORAGE_KEY = "noatinwork_session_load_perf"
...
declare global {
  interface Window {
    __noatinworkSessionLoadPerformance?: SessionLoadPerformanceState
  }
}
...
export function startSessionLoadPerformanceEvent(input: Omit<SessionLoadPerformanceEvent, "at" | "durationMs" | "outcome">) {
  ...
  return (
    ...
    const state = window.__noatinworkSessionLoadPerformance ?? { events: [] }
    ...
    window.__noatinworkSessionLoadPerformance = state
  }
}
...
const FIRST_VISIBLE_MARK = "noatinwork.chat.first_message_visible"
