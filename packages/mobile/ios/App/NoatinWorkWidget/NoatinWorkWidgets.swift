...
struct OverviewWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("NoatinWork")
...
struct QuickActionsWidget: Widget {
    let kind = "NoatinWorkQuickActions"
...
struct LockAttentionWidget: Widget {
    let kind = "NoatinWorkLockAttention"
...
@main
struct NoatinWorkWidgetBundle: WidgetBundle {
