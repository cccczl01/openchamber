...
export const IDLE_PROBE_GLOBAL = "__noatinworkIdleProbe"

const probeFactory = function installNoatinWorkIdleProbe(globalName, stackCaptureBudget) {
  ...
  const siteFromStack = (kind) => {
    ...
    for (const line of lines) {
      ...
      if (line.includes("installNoatinWorkIdleProbe")) continue
