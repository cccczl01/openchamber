...
describe('normalizeCustomOpenAIBaseURL', () => {
  const originalRuntime = process.env.NOATINWORK_RUNTIME;
  const originalAllowRemote = process.env.NOATINWORK_ALLOW_REMOTE_OPENAI_COMPAT_URLS;

  afterEach(() => {
    // Restore env vars after each test
    if (originalRuntime === undefined) {
      delete process.env.NOATINWORK_RUNTIME;
    } else {
      process.env.NOATINWORK_RUNTIME = originalRuntime;
    }
    if (originalAllowRemote === undefined) {
      delete process.env.NOATINWORK_ALLOW_REMOTE_OPENAI_COMPAT_URLS;
    } else {
      process.env.NOATINWORK_ALLOW_REMOTE_OPENAI_COMPAT_URLS = originalAllowRemote;
    }
  });

  it('rejects remote URLs when NOATINWORK_RUNTIME is not set (web)', () => {
    delete process.env.NOATINWORK_RUNTIME;
    delete process.env.NOATINWORK_ALLOW_REMOTE_OPENAI_COMPAT_URLS;
  ...
  it('allows remote URLs when NOATINWORK_RUNTIME is desktop', () => {
  ...
  it('allows remote URLs when NOATINWORK_ALLOW_REMOTE_OPENAI_COMPAT_URLS is true', () => {
    delete process.env.NOATINWORK_RUNTIME;
    process.env.NOATINWORK_ALLOW_REMOTE_OPENAI_COMPAT_URLS = 'true';
  ...
  it('denies remote URLs on desktop when env var is explicitly false', () => {
    process.env.NOATINWORK_RUNTIME = 'desktop';
    process.env.NOATINWORK_ALLOW_REMOTE_OPENAI_COMPAT_URLS = 'false';
