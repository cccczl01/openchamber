 ...
 * payloads must be parsed for paths, and NoatinWork's own file tree marks an
...
/** Data type marking a drag that started in NoatinWork's own file tree. */
export const INTERNAL_FILE_PATH_TYPE = 'application/x-noatinwork-file-path';
