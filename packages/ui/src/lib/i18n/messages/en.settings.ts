export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. NoatinWork never scans browser cookie storage.',
  ...
  'settings.window.description': 'NoatinWork settings window.',
  ...
  'settings.view.nav.group.general': 'NoatinWork',
  ...
  'settings.page.appearance.description': 'Customize how NoatinWork looks and feels.',
  ...
  'settings.noatinwork.tunnel.title': 'External Tunnel',
  'settings.noatinwork.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.noatinwork.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.noatinwork.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.noatinwork.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.noatinwork.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.noatinwork.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.noatinwork.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.noatinwork.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.noatinwork.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.noatinwork.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.noatinwork.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.noatinwork.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.noatinwork.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.noatinwork.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.noatinwork.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.noatinwork.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.noatinwork.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.noatinwork.tunnel.field.provider': 'Provider',
  'settings.noatinwork.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.noatinwork.tunnel.field.tunnelType': 'Tunnel type',
  'settings.noatinwork.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.noatinwork.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.noatinwork.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.noatinwork.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.noatinwork.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.noatinwork.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.noatinwork.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.noatinwork.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.noatinwork.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.noatinwork.tunnel.field.configurationFile': 'Configuration file',
  'settings.noatinwork.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.noatinwork.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.noatinwork.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.noatinwork.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.noatinwork.tunnel.field.connectLink': 'Connect link',
  'settings.noatinwork.tunnel.field.expires': 'Expires',
  'settings.noatinwork.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.noatinwork.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.noatinwork.tunnel.actions.saveToken': 'Save token',
  'settings.noatinwork.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.noatinwork.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.noatinwork.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.noatinwork.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.noatinwork.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.noatinwork.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.noatinwork.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.noatinwork.tunnel.actions.stopping': 'Stopping...',
  'settings.noatinwork.tunnel.actions.newConnectLink': 'New connect link',
  'settings.noatinwork.tunnel.actions.copied': 'Copied',
  'settings.noatinwork.tunnel.actions.retry': 'Retry',
  'settings.noatinwork.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.noatinwork.tunnel.option.mode.quick.label': 'Quick',
  'settings.noatinwork.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.noatinwork.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.noatinwork.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.noatinwork.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.noatinwork.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.noatinwork.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.noatinwork.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  'settings.noatinwork.tunnel.badge.quick': 'QUICK',
  'settings.noatinwork.tunnel.badge.remote': 'REMOTE',
  'settings.noatinwork.tunnel.badge.local': 'LOCAL',
  'settings.noatinwork.tunnel.state.loading': 'Loading',
  'settings.noatinwork.tunnel.state.expired': 'Expired',
  'settings.noatinwork.tunnel.state.revoked': 'Revoked',
  'settings.noatinwork.tunnel.state.inactive': 'Inactive',
  'settings.noatinwork.tunnel.state.noExpiry': 'No expiry',
  'settings.noatinwork.tunnel.state.never': 'Never',
  'settings.noatinwork.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.noatinwork.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.noatinwork.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.noatinwork.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.noatinwork.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.noatinwork.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/noatinwork/cloudflare-managed-remote-tunnels.json.',
  'settings.noatinwork.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.noatinwork.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.noatinwork.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.noatinwork.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.noatinwork.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.noatinwork.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.noatinwork.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.noatinwork.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.noatinwork.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.noatinwork.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.noatinwork.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.noatinwork.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.noatinwork.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.noatinwork.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.noatinwork.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.noatinwork.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.noatinwork.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.noatinwork.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.noatinwork.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.noatinwork.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.noatinwork.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.noatinwork.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.noatinwork.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.noatinwork.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.noatinwork.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.noatinwork.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.direct.title': 'Other NoatinWork servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another NoatinWork server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another NoatinWork server.',
  'settings.remoteInstances.direct.import.placeholder': 'noatinwork://connect?...',
  'settings.remoteInstances.direct.import.action': 'Import Link',
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid NoatinWork connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so NoatinWork Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrAlt': 'NoatinWork connection QR code',
  'settings.remoteInstances.clientAuth.qrEnlarge': 'Enlarge QR code',
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the NoatinWork app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through NoatinWork Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.title': 'NoatinWork Relay',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the NoatinWork app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether NoatinWork should start the server for you, or connect to one that is already running.',
  ...
  'settings.remoteInstances.page.field.keepServerRunningHint': 'Keep NoatinWork running on the remote machine after you disconnect.',
  ...
  'settings.noatinwork.about.title': 'About NoatinWork',
  'settings.noatinwork.about.field.version': 'Version',
  'settings.noatinwork.about.field.openCodeVersion': 'OpenCode version',
  'settings.noatinwork.about.field.instanceUrls': 'Instance URLs',
  'settings.noatinwork.about.field.applicationUrl': 'Application',
  'settings.noatinwork.about.field.tunnelUrl': 'Tunnel',
  'settings.noatinwork.about.state.checking': 'Checking...',
  'settings.noatinwork.about.state.upToDate': 'Up to date',
  'settings.noatinwork.about.state.unknown': 'unknown',
  'settings.noatinwork.about.actions.checkUpdates': 'Check updates',
  'settings.noatinwork.about.actions.update': 'Update',
  'settings.noatinwork.about.actions.updateToVersion': 'Update to {version}',
  'settings.noatinwork.about.actions.checkForUpdates': 'Check for updates',
  'settings.noatinwork.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. NoatinWork will scan it for folders containing',
  ...
  'settings.noatinwork.passkeys.title': 'Passkeys',
  'settings.noatinwork.passkeys.field.currentDevice': 'Current device',
  'settings.noatinwork.passkeys.actions.add': 'Add passkey',
  'settings.noatinwork.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.noatinwork.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.noatinwork.passkeys.actions.signingOut': 'Signing out…',
  'settings.noatinwork.passkeys.actions.removing': 'Removing…',
  'settings.noatinwork.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.noatinwork.passkeys.state.loading': 'Loading passkeys…',
  'settings.noatinwork.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.noatinwork.passkeys.item.lastUsed': 'Last used {time}',
  'settings.noatinwork.passkeys.item.added': 'Added {time}',
  'settings.noatinwork.passkeys.time.neverUsed': 'Never used',
  'settings.noatinwork.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.noatinwork.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.noatinwork.passkeys.toast.added': 'Passkey added',
  'settings.noatinwork.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.noatinwork.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.noatinwork.passkeys.toast.removed': 'Passkey removed',
  'settings.noatinwork.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.noatinwork.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.noatinwork.sessionRetention.title': 'Session Retention',
  'settings.noatinwork.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.noatinwork.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.noatinwork.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.noatinwork.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.noatinwork.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.noatinwork.sessionRetention.field.days': 'days',
  'settings.noatinwork.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.noatinwork.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.noatinwork.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.noatinwork.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.noatinwork.sessionRetention.action.archive': 'Archive',
  'settings.noatinwork.sessionRetention.action.delete': 'Delete',
  'settings.noatinwork.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.noatinwork.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.noatinwork.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.noatinwork.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.noatinwork.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.noatinwork.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.noatinwork.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.noatinwork.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.noatinwork.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.noatinwork.desktopNetwork.title': 'Desktop Network Access',
  'settings.noatinwork.desktopNetwork.field.windowControlsPosition': 'Window controls position',
  'settings.noatinwork.desktopNetwork.field.windowControlsPositionDescription': 'Choose where minimize, maximize, and close buttons appear. Defaults to the right.',
  'settings.noatinwork.desktopNetwork.field.windowControlsPositionAria': 'Window controls position',
  'settings.noatinwork.desktopNetwork.option.windowControlsLeft': 'Left',
  'settings.noatinwork.desktopNetwork.option.windowControlsRight': 'Right',
  'settings.noatinwork.desktopNetwork.field.windowControls': 'Window controls',
  'settings.noatinwork.desktopNetwork.field.windowControlsStyle': 'Style',
  'settings.noatinwork.desktopNetwork.field.windowControlsStyleAria': 'Window controls style',
  'settings.noatinwork.desktopNetwork.option.windowControlsClassic': 'Classic',
  'settings.noatinwork.desktopNetwork.option.windowControlsTrafficLights': 'Traffic lights',
  'settings.noatinwork.desktopNetwork.field.launchAtLoginAria': 'Start NoatinWork at login',
  'settings.noatinwork.desktopNetwork.field.launchAtLogin': 'Start NoatinWork when you log in',
  'settings.noatinwork.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Use the desktop status icon to open it.',
  'settings.noatinwork.desktopNetwork.field.macMenuBarAria': 'Show NoatinWork in the macOS menu bar',
  'settings.noatinwork.desktopNetwork.field.macMenuBar': 'Show NoatinWork in the menu bar',
  'settings.noatinwork.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, NoatinWork does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.noatinwork.desktopNetwork.field.minimizeToTrayAria': 'Minimize and close NoatinWork to the system tray',
  'settings.noatinwork.desktopNetwork.field.minimizeToTray': 'Minimize and close to the system tray',
  'settings.noatinwork.desktopNetwork.field.minimizeToTrayDescription': 'Keeps NoatinWork running in the system tray when the main window is minimized or closed.',
  'settings.noatinwork.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while NoatinWork is running',
  'settings.noatinwork.desktopNetwork.field.keepAwake': 'Keep computer awake while NoatinWork is running',
  'settings.noatinwork.desktopNetwork.field.keepAwakeDescription': 'Prevents system sleep so phones can keep reaching this app. The screen can still turn off.',
  'settings.noatinwork.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.noatinwork.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.noatinwork.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.noatinwork.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.noatinwork.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.noatinwork.desktopPassword.actions.showPassword': 'Show password',
  'settings.noatinwork.desktopPassword.actions.hidePassword': 'Hide password',
  'settings.noatinwork.desktopPassword.field.password': 'Desktop UI Password',
  'settings.noatinwork.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.noatinwork.desktopPassword.field.passwordDescription': 'NoatinWork asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.noatinwork.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.noatinwork.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.noatinwork.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.noatinwork.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.noatinwork.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.noatinwork.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.noatinwork.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.noatinwork.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.noatinwork.desktopNetwork.error.minimizeToTrayUnsupported': 'System tray background mode is not supported on this system',
  'settings.noatinwork.desktopNetwork.error.minimizeToTraySaveFailed': 'Failed to update system tray setting',
  'settings.noatinwork.desktopNetwork.error.keepAwakeUnsupported': 'Preventing sleep is not supported on this system',
  'settings.noatinwork.desktopNetwork.error.keepAwakeSaveFailed': 'Failed to update keep awake setting',
  'settings.noatinwork.opencodeCli.title': 'OpenCode CLI',
  'settings.noatinwork.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.noatinwork.opencodeCli.tooltipSuffix': 'binary.',
  'settings.noatinwork.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.noatinwork.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.noatinwork.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  'settings.noatinwork.opencodeCli.field.showUpdateNotificationsAria': 'Show OpenCode update notifications',
  'settings.noatinwork.opencodeCli.field.agentControlTool': 'Agent control tool',
  'settings.noatinwork.opencodeCli.field.agentControlToolAria': 'Enable the agent control tool',
  'settings.noatinwork.opencodeCli.field.agentControlToolInfo': 'Let agents orchestrate your work from chat: spin up sessions and worktrees, delegate prompts to other agents, and manage scheduled tasks. Adds a small tool description to each session. Applies after Save + Reload.',
  'settings.noatinwork.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.noatinwork.opencodeCli.actions.browse': 'Browse',
  'settings.noatinwork.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.noatinwork.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.noatinwork.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.noatinwork.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.noatinwork.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.noatinwork.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.noatinwork.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.noatinwork.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.noatinwork.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.noatinwork.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.noatinwork.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.noatinwork.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.noatinwork.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.noatinwork.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.noatinwork.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.noatinwork.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.noatinwork.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.noatinwork.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.noatinwork.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.noatinwork.keyboardShortcuts.action.add_selection_to_chat.label': 'Add selection to chat',
  'settings.noatinwork.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.noatinwork.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle context panel',
  'settings.noatinwork.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open Git surface',
  'settings.noatinwork.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open Files surface',
  'settings.noatinwork.keyboardShortcuts.action.switch_context_surface.label': 'Switch context panel surface',
  'settings.noatinwork.keyboardShortcuts.action.switch_context_surface.suffix': ' + 1…0',
  'settings.noatinwork.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.noatinwork.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.noatinwork.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.noatinwork.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.noatinwork.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.noatinwork.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.noatinwork.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.noatinwork.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.noatinwork.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.noatinwork.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.noatinwork.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.noatinwork.keyboardShortcuts.action.open_model_selector.label': 'Open model selector',
  'settings.noatinwork.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.noatinwork.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  'settings.noatinwork.keyboardShortcuts.action.toggle_prompt_navigator.label': 'Toggle prompt navigator',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open NoatinWork there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'NoatinWork on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how NoatinWork should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote NoatinWork server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote NoatinWork UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How NoatinWork should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingNoatinWork': 'Installing NoatinWork',
  'settings.remoteInstances.page.phase.updatingNoatinWork': 'Updating NoatinWork',
  ...
  'settings.noatinwork.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.noatinwork.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.noatinwork.worktrees.setup.title': 'Setup commands',
  'settings.noatinwork.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.noatinwork.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.noatinwork.worktrees.setup.loading': 'Loading...',
  'settings.noatinwork.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.noatinwork.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.noatinwork.worktrees.setup.addCommand': 'Add command',
  'settings.noatinwork.worktrees.setup.waitForCommands': 'Wait for setup commands before creating or sending a session',
  'settings.noatinwork.worktrees.setup.waitForCommandsAria': 'Wait for Worktree setup commands before creating or sending a session',
  'settings.noatinwork.worktrees.setup.toast.saveFailed': 'Failed to save worktree setup commands',
  'settings.noatinwork.worktrees.list.title': 'Existing worktrees',
  'settings.noatinwork.worktrees.list.tooltip': 'Deleting a worktree also removes its linked sessions.',
  'settings.noatinwork.worktrees.list.loading': 'Loading worktrees...',
  'settings.noatinwork.worktrees.list.empty': 'No worktrees found for this project',
  'settings.noatinwork.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.noatinwork.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by NoatinWork. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by NoatinWork.',
  ...
  'settings.noatinwork.defaults.title': 'Session Defaults',
  'settings.noatinwork.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.noatinwork.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  'settings.noatinwork.defaults.field.defaultModel': 'Default Model',
  'settings.noatinwork.defaults.field.defaultThinking': 'Default Thinking',
  'settings.noatinwork.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.noatinwork.defaults.field.defaultAgent': 'Default Agent',
  'settings.noatinwork.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.noatinwork.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.noatinwork.defaults.smallModel.title': 'Small Model',
  'settings.noatinwork.defaults.smallModel.description': 'A cheap model for quick utility tasks like short recaps and summaries.',
  'settings.noatinwork.defaults.smallModel.useDefault': 'Use default small model',
  'settings.noatinwork.defaults.smallModel.useDefaultAria': 'Use default small model',
  'settings.noatinwork.defaults.smallModel.overrideModel': 'Override model',
  'settings.noatinwork.defaults.walkthroughModel.title': 'Changes Walkthrough Model',
  'settings.noatinwork.defaults.walkthroughModel.description': 'The AI review of your changes needs structured output and room for a whole diff, which a cheap small model often cannot give. Models the catalog reports as unable to produce structured output are hidden from this picker. Leave it unset and the small model is used.',
  'settings.noatinwork.defaults.walkthroughModel.overrideModel': 'Walkthrough model',
  'settings.noatinwork.defaults.walkthroughModel.usesSmallModel': 'Small model',
  'settings.noatinwork.defaults.field.openFilesPreviewAria': 'Open previewable files in preview mode',
  'settings.noatinwork.defaults.field.openFilesPreview': 'Open previewable files in preview mode',
  'settings.noatinwork.defaults.option.default': 'Default',
  'settings.noatinwork.defaults.option.defaultLowercase': 'default',
  'settings.noatinwork.git.title': 'Git Preferences',
  'settings.noatinwork.git.changesViewTitle': 'Changes View',
  'settings.noatinwork.git.changesViewAria': 'Git changes view mode',
  'settings.noatinwork.git.option.flatList': 'Flat List',
  'settings.noatinwork.git.option.treeView': 'Tree View',
  'settings.noatinwork.git.optionAria': 'Git changes view mode: {option}',
  'settings.noatinwork.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.noatinwork.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.noatinwork.git.showGitignoredAria': 'Display gitignored files',
  'settings.noatinwork.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize NoatinWork',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if NoatinWork auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from NoatinWork.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the NoatinWork server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the NoatinWork server (Kokoro, English). The model downloads automatically; no API key needed.',
  ...
  'settings.noatinwork.visual.section.colorMode': 'Color Mode',
  'settings.noatinwork.visual.section.colorModeAndTheme': 'Color mode & Theme',
  'settings.noatinwork.visual.section.mobileLayout': 'Mobile Layout',
  'settings.noatinwork.visual.option.mobileLayout.default': 'Old',
  'settings.noatinwork.visual.option.mobileLayout.new': 'New',
  'settings.noatinwork.visual.section.localization': 'Localization',
  'settings.noatinwork.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.noatinwork.visual.section.densityAndType': 'Density & type',
  'settings.noatinwork.visual.section.appInstall': 'App install',
  'settings.noatinwork.visual.section.navigation': 'Navigation',
  'settings.noatinwork.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.noatinwork.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.noatinwork.visual.section.chatDisplay': 'Display',
  'settings.noatinwork.visual.section.chatMessageOptions': 'Message options',
  'settings.noatinwork.visual.section.chatFeatures': 'Features',
  'settings.noatinwork.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.noatinwork.visual.section.activityDefault': 'Activity Default',
  'settings.noatinwork.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.noatinwork.visual.section.showToolsOpenedByDefault': 'Show tools opened by default',
  'settings.noatinwork.visual.section.sessionAssistance': 'Session Assistance',
  'settings.noatinwork.visual.section.reasoning': 'Reasoning',
  'settings.noatinwork.visual.section.messageAppearance': 'Message Appearance',
  'settings.noatinwork.visual.section.toolsAndFiles': 'Tools & Files',
  'settings.noatinwork.visual.section.composer': 'Composer',
  'settings.noatinwork.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.noatinwork.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.noatinwork.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.noatinwork.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.noatinwork.visual.section.diffLayout': 'Diff Layout',
  'settings.noatinwork.visual.section.diffLayoutAria': 'Diff layout',
  'settings.noatinwork.visual.section.privacy': 'Privacy',
  'settings.noatinwork.visual.field.lightTheme': 'Light Theme',
  'settings.noatinwork.visual.field.darkTheme': 'Dark Theme',
  'settings.noatinwork.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.noatinwork.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.noatinwork.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.noatinwork.visual.field.timeFormat': 'Time Format',
  'settings.noatinwork.visual.field.weekStartsOn': 'Week Starts On',
  'settings.noatinwork.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.noatinwork.visual.field.selectWeekStartAria': 'Select week start',
  'settings.noatinwork.visual.actions.reloadThemes': 'Reload themes',
  'settings.noatinwork.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.noatinwork.visual.field.dockBadge': 'Dock badge',
  'settings.noatinwork.visual.field.dockBadgeHint': 'Show a count of chats with unseen activity on the macOS dock icon.',
  'settings.noatinwork.visual.actions.saveAndRestart': 'Save & restart',
  'settings.noatinwork.visual.actions.restarting': 'Restarting…',
  'settings.noatinwork.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.noatinwork.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/noatinwork/themes/',
  'settings.noatinwork.visual.field.installAppName': 'Install App Name',
  'settings.noatinwork.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.noatinwork.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.noatinwork.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.noatinwork.visual.field.installOrientation': 'Install Orientation',
  'settings.noatinwork.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.noatinwork.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.noatinwork.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.noatinwork.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.noatinwork.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.noatinwork.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.noatinwork.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.noatinwork.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.noatinwork.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.noatinwork.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.noatinwork.visual.field.interfaceFont': 'Interface Font',
  'settings.noatinwork.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.noatinwork.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.noatinwork.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.noatinwork.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.noatinwork.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.noatinwork.visual.field.terminalShell': 'Terminal Shell',
  'settings.noatinwork.visual.field.terminalShellAria': 'Select terminal shell',
  'settings.noatinwork.visual.field.terminalShellHint': 'Restart the terminal to apply this change to the current session.',
  'settings.noatinwork.visual.field.terminalLoginShell': 'Start as login shell',
  'settings.noatinwork.visual.option.terminalShell.auto': 'Auto',
  'settings.noatinwork.visual.field.editorFontSize': 'Editor Font Size',
  'settings.noatinwork.visual.field.codeFont': 'Code Font',
  'settings.noatinwork.visual.field.selectCodeFontAria': 'Select code font',
  'settings.noatinwork.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.noatinwork.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.noatinwork.visual.actions.resetEditorFontSizeAria': 'Reset editor font size',
  'settings.noatinwork.visual.field.spacingDensity': 'Spacing Density',
  'settings.noatinwork.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.noatinwork.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.noatinwork.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.noatinwork.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.noatinwork.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.noatinwork.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.noatinwork.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.noatinwork.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.noatinwork.visual.option.fileEditorKeymap.default': 'Default',
  'settings.noatinwork.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.noatinwork.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.noatinwork.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.noatinwork.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.noatinwork.visual.field.bash': 'Bash',
  'settings.noatinwork.visual.field.editTools': 'Edit tools',
  'settings.noatinwork.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  'settings.noatinwork.visual.field.mermaidRenderingAria': 'Mermaid rendering: {option}',
  'settings.noatinwork.visual.field.diffLayoutAria': 'Diff layout: {option}',
  'settings.noatinwork.visual.field.sessionRecap': 'Generate Session Recap',
  'settings.noatinwork.visual.field.sessionRecapAria': 'Generate a recap after the agent finishes',
  'settings.noatinwork.visual.field.sessionSuggestion': 'Generate Next User Message Suggestion',
  'settings.noatinwork.visual.field.sessionSuggestionAria': 'Generate a suggested next user message after the agent finishes',
  'settings.noatinwork.visual.field.sessionGoal': 'Enable Session Goals',
  'settings.noatinwork.visual.field.sessionGoalAria': 'Keep the session working toward a goal automatically',
  'settings.noatinwork.visual.goal.sectionTitle': 'Goal',
  'settings.noatinwork.visual.goal.budgetLabel': 'Default token budget',
  'settings.noatinwork.visual.goal.budgetAria': 'Apply a default token budget to new goals',
  'settings.noatinwork.visual.goal.description': 'Arm the target button in the composer and the next message becomes a goal: the agent keeps working toward it automatically, audited by the small model, even while you are away.',
  'settings.noatinwork.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.noatinwork.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.noatinwork.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.noatinwork.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.noatinwork.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.noatinwork.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.noatinwork.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.noatinwork.visual.field.stickyUserHeader': 'Sticky User Header',
  'settings.noatinwork.visual.field.promptNavigatorEnabledAria': 'Prompt navigator',
  'settings.noatinwork.visual.field.promptNavigatorEnabled': 'Prompt Navigator',
  'settings.noatinwork.visual.field.expandedEditorToolbarAria': 'Always show editor toolbar',
  'settings.noatinwork.visual.field.expandedEditorToolbar': 'Always show editor toolbar (docked under the file tabs)',
  'settings.noatinwork.visual.field.autoSaveEnabledAria': 'Auto-save files',
  'settings.noatinwork.visual.field.autoSaveEnabled': 'Auto-save files',
  'settings.noatinwork.visual.field.autoSaveEnabledInfo': 'Automatically save file edits after you stop typing. Disable to require manual save.',
  'settings.noatinwork.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.noatinwork.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.noatinwork.visual.field.codeBlockLineWrapAria': 'Wrap code block lines',
  'settings.noatinwork.visual.field.codeBlockLineWrap': 'Wrap Code Block Lines',
  'settings.noatinwork.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.noatinwork.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.noatinwork.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.noatinwork.visual.field.allowPromptingSubagentSessionsAria': 'Allow prompting subagent sessions',
  'settings.noatinwork.visual.field.allowPromptingSubagentSessions': 'Allow Prompting Subagent Sessions',
  'settings.noatinwork.visual.field.draftStartersVisible': 'Show Starters on New Session Screen',
  'settings.noatinwork.visual.field.draftStartersVisibleAria': 'Show starters on the new session screen',
  'settings.noatinwork.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.noatinwork.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.noatinwork.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.noatinwork.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.noatinwork.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.noatinwork.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.noatinwork.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.noatinwork.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.noatinwork.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.noatinwork.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.noatinwork.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.noatinwork.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.noatinwork.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.noatinwork.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.noatinwork.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.noatinwork.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.noatinwork.visual.option.themeMode.system': 'System',
  'settings.noatinwork.visual.option.themeMode.system.description': 'Follow system setting',
  'settings.noatinwork.visual.option.themeMode.light': 'Light',
  'settings.noatinwork.visual.option.themeMode.light.description': 'Always use light appearance',
  'settings.noatinwork.visual.option.themeMode.dark': 'Dark',
  'settings.noatinwork.visual.option.themeMode.dark.description': 'Always use dark appearance',
  'settings.noatinwork.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.noatinwork.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.noatinwork.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.noatinwork.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.noatinwork.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.noatinwork.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.noatinwork.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.noatinwork.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.noatinwork.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.noatinwork.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.noatinwork.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.noatinwork.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.noatinwork.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.noatinwork.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.noatinwork.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.noatinwork.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.noatinwork.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.noatinwork.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.noatinwork.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.noatinwork.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.noatinwork.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.noatinwork.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.noatinwork.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.noatinwork.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.noatinwork.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.noatinwork.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.noatinwork.visual.option.chatRenderMode.live.label': 'Live',
  'settings.noatinwork.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.noatinwork.visual.option.messageTransport.auto.label': 'Auto',
  'settings.noatinwork.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.noatinwork.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.noatinwork.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.noatinwork.visual.option.messageTransport.sse.label': 'SSE',
  'settings.noatinwork.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.noatinwork.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.noatinwork.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.noatinwork.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.noatinwork.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.noatinwork.visual.option.timeFormat.auto.label': 'Auto',
  'settings.noatinwork.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.noatinwork.visual.option.timeFormat.24h.label': '24-hour',
  'settings.noatinwork.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.noatinwork.visual.option.timeFormat.12h.label': '12-hour',
  'settings.noatinwork.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.noatinwork.visual.option.weekStart.auto.label': 'Auto',
  'settings.noatinwork.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.noatinwork.visual.option.weekStart.monday.label': 'Monday',
  'settings.noatinwork.visual.option.weekStart.sunday.label': 'Sunday',
  ...
  'settings.noatinwork.visual.section.followUpBehavior': 'Follow-up behavior',
  'settings.noatinwork.visual.section.followUpBehaviorAria': 'Follow-up behavior',
  'settings.noatinwork.visual.field.followUpBehaviorAria': 'Follow-up behavior: {option}',
  'settings.noatinwork.visual.field.followUpBehaviorDescription': 'Choose what happens when you press Enter on a follow-up message while the agent is still responding.',
  'settings.noatinwork.visual.option.followUpBehavior.steer.label': 'Steer',
  'settings.noatinwork.visual.option.followUpBehavior.queue.label': 'Queue',
} as const;
