...
export const PluginsSidebar: React.FC<PluginsSidebarProps> = ({
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('noatinwork:settings-open-plugin-add', handleOpenAdd);
    return () => window.removeEventListener('noatinwork:settings-open-plugin-add', handleOpenAdd);
  }, []);
