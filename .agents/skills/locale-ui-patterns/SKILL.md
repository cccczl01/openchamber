...
description: Use when creating or modifying NoatinWork UI text, labels, buttons, placeholders, aria labels, empty states, toasts, dialogs, settings copy, navigation labels, or any user-facing strings.
---
...
'chat.input.placeholder': 'Ask NoatinWork...'
```
...
'Language': 'Language'
'chatLabel': 'Chat'
'askNoatinWorkDotDotDot': 'Ask NoatinWork...'
```
...
- Product names: `NoatinWork`, `OpenCode`, `GitHub`
